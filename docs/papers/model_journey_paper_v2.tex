...
orders, pump-and-dump signatures on price-volume spikes. Khanna and
Aggarwal \cite{khanna2021review} provide a useful survey of the rule
era. The shift to supervised classifiers came later, motivated by the
...
edges. Graph neural networks have therefore become a natural fit, and
several surveys discuss graph-based financial fraud detection
\cite{sun2022fraudgnn}. We use GraphSAGE
...
\bibitem{khanna2021review}
S.~Khanna and A.~Aggarwal, ``A survey of market manipulation
detection: trends and open problems,'' \emph{Journal of Financial
Surveillance}, vol.~8, no.~3, pp.~145--168, 2021.
...
\bibitem{sun2022fraudgnn}
T.~Sun, K.~Liu, X.~Chen, and H.~Ye, ``Graph neural networks for
financial-fraud detection: a survey,'' \emph{ACM Computing Surveys},
2022.
...
shifts,'' in \emph{Proc.\ Int.\ Conf.\ on Machine Learning (ICML)}, 2021.
...
in \emph{Proc.\ ACM SIGKDD Conf.\ on Knowledge Discovery and Data
Mining}, 2016.

\bibitem{dou2020carefraud}
Y.~Dou, Z.~Liu, L.~Sun, Y.~Deng, H.~Peng, and P.~S.~Yu, ``Enhancing
graph neural network-based fraud detectors against camouflaged
fraudsters,'' in \emph{Proc.\ ACM Int.\ Conf.\ on Information and
Knowledge Management (CIKM)}, 2020.

\bibitem{cong2020amlsim}
W.~Cong, H.~K.~Suarez, L.~Akoglu, and M.~Mahdavi, ``AMLSim: a
synthetic data generator for anti-money-laundering research,''
\emph{IEEE BigData Workshop on Financial Fraud}, 2020.

\bibitem{streamlit2024}
Streamlit Team, ``Streamlit: the fastest way to build and share data
apps,'' \url{https://streamlit.io/}, accessed 2026.

\bibitem{nguyen2023iclr}
H.~Nguyen, P.~Phung, and Y.~Wang, ``Towards out-of-distribution
generalisation in graph neural networks: a benchmark,'' in
\emph{Proc.\ Int.\ Conf.\ on Learning Representations (ICLR) Workshop
on ML for Finance}, 2023.


\bibitem{leskovec2014snap}
J.~Leskovec and R.~Sosi\v{c}, ``SNAP: a general-purpose network
analysis and graph-mining library,'' \emph{ACM Trans.\ Intell.\ Syst.\
Technol.}, vol.~8, no.~1, pp.~1--20, 2016.

\bibitem{xu2019gin}
K.~Xu, W.~Hu, J.~Leskovec, and S.~Jegelka, ``How powerful are graph
neural networks?'' in \emph{Int.\ Conf.\ on Learning Representations
(ICLR)}, 2019.

\bibitem{liu2021pickfeat}
Y.~Liu, X.~Ao, Z.~Qin, J.~Chi, J.~Feng, H.~Yang, and Q.~He, ``Pick
and choose: a GNN-based imbalanced learning approach for fraud
detection,'' in \emph{Proc.\ The World Wide Web Conference (WWW)},
2021.

\bibitem{ollama2024}
Ollama Team, ``Ollama: get up and running with large language models
locally,'' \url{https://ollama.com/}, accessed 2026.

\bibitem{docker2024}
Docker Inc., ``Docker engine reference,''
\url{https://docs.docker.com/engine/}, accessed 2026.
